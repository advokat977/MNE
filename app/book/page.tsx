        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg text-subtle max-w-prose">
              Board-ready due diligence, transaction execution, and concession strategy —
              EU standards, Montenegro know-how. Reports prepared by a licensed attorney
              with 20+ years of courtroom and corporate experience.
            </p>
      ...
      <Section id="about" className="bg-white border-y border-gray-200">
        <div className="container py-16">
          ...
          <p className="mt-4 text-subtle leading-relaxed max-w-3xl">
            ...
            rules and cross-border business. This background ensures that each report delivered
            by MNE Consulting is both source-anchored and board-ready — a decisive advantage
      ...
      <Section id="contact">
        <div className="container">
          ...
          <div className="mx-auto mt-10 max-w-2xl bg-white border border-gray-200 rounded-2xl p-6">
            <ContactForm />
            {/* Samo JEDNA napomena ispod forme */}
