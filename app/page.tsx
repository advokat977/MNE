        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg text-subtle max-w-prose">
              Board-ready due diligence, transaction execution, and concession strategy — EU standards,
              Montenegro know-how. Reports prepared by a licensed attorney with 20+ years of courtroom and
        ...
        <p className="mt-3 text-center text-subtle">Clear ranges. Serious intent.</p>
          ...
          <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={pkg.title}
                className={`rounded-2xl p-8 border ${pkg.featured ? "border-2 border-black shadow-sm" : "border-gray-200"} bg-white`}
              >
      ...
      <Section id="about" className="bg-white border-y border-gray-200">
        <div className="container py-16">
          ...
          <p className="mt-4 text-subtle leading-relaxed max-w-3xl">
            With over two decades of practice, Dejan Radinović has advised the Government of Montenegro
            and leading international corporations on some of the country’s most significant privatizations
            and investment projects. His track record includes high-stakes due diligence exercises,
            complex M&A transactions, and representation in international arbitration disputes exceeding €800 million.
          </p>
          <p className="mt-4 text-subtle leading-relaxed max-w-3xl">
            Dejan combines deep knowledge of Montenegrin law with an understanding of EU regulatory standards,
            offering investors rare clarity at the intersection of local rules and cross-border business.
            This background ensures that each report delivered by MNE Consulting is both source-anchored and
            board-ready — a decisive advantage for EU clients evaluating opportunities in Montenegro.
          </p>
      ...
      <Section id="contact">
        <div className="container">
          ...
          <div className="mx-auto mt-10 max-w-2xl bg-white border border-gray-200 rounded-2xl p-6">
            <ContactForm />
            <div className="mt-4 text-sm text-subtle text-center sm:text-left">
